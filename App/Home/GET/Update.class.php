...
class Update extends \App\Home\Common {
    ...
    public function index() {
        ...
        $update = array('version' => $list['update_title'], 'content' => $list['update_content'], 'createtime' => $list['update_createtime'], 'file' => $url['value'] . $list['update_file'], 'sql' => $url['value'] . $list['update_sql']);
