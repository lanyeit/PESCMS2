<form action="/" method="get">
    <div class="am-input-group am-margin-bottom">
        ...
        <input type="hidden" name="su"
               value="<?= is_numeric($_GET['su']) ? $_GET['su'] : ''; ?>">
...
<div class="am-panel am-panel-default">
    ...
    <ul class="am-list am-list-static am-nav">
        <li class="am-padding-0 am-margin-top-0">
            <a href="<?= $label->url('Process-index', array('su' => '', 'p' => $_GET['p'] ?: '0', 'u' => $_GET['u'] ?: '0', 'k' => $_GET['k'])); ?>"
               class=" am-link-muted">
        ...
        <?php foreach ($status as $key => $value) : ?>
            <li class="am-padding-0 am-margin-top-0 <?= $_GET['su'] == $key && is_numeric($_GET['su']) ? 'am-active' : ''; ?>">
                <a href="<?= $label->url('Process-index', array('su' => $key, 'p' => $_GET['p'] ?: '0', 'u' => $_GET['u'] ?: '0', 'k' => $_GET['k'])); ?>"
...
<div class="am-panel am-panel-default">
    ...
    <ul class="am-list am-list-static am-nav">
        <li class="am-padding-0 am-margin-top-0">
            <a href="<?= $label->url('Process-index', array('su' => is_numeric($_GET['su']) ? $_GET['su'] : '', 'p' => '', 'u' => $_GET['u'] ?: '0', 'k' => $_GET['k'])); ?>"
               class=" am-link-muted">
        ...
        <?php foreach ($project as $key => $value) : ?>
            <li class="am-padding-0 am-margin-top-0 <?= $_GET['p'] == $value['project_id'] ? 'am-active' : ''; ?>">
                <a href="<?= $label->url('Process-index', array('su' => is_numeric($_GET['su']) ? $_GET['su'] : '', 'p' => $value['project_id'], 'u' => $_GET['u'] ?: '0', 'k' => $_GET['k'])); ?>"
                   class="am-link-muted">
...
<div class="am-panel am-panel-default">
    ...
    <ul class="am-list am-list-static am-nav ">
        <li class="am-padding-0 am-margin-top-0">
            <a href="<?= $label->url('Process-index', array('su' => is_numeric($_GET['su']) ? $_GET['su'] : '', 'p' => $_GET['p'], 'u' => '', 'k' => $_GET['k'])); ?>"
               class=" am-link-muted">
        ...
        <?php foreach ($hero as $key => $value) : ?>
            <li class="am-padding-0 am-margin-top-0 <?= $_GET['u'] == $value['user_id'] ? 'am-active' : ''; ?>">
                <a href="<?= $label->url('Process-index', array('su' => is_numeric($_GET['su']) ? $_GET['su'] : '', 'p' => $_GET['p'] ?: '0', 'u' => $value['user_id'], 'k' => $_GET['k'])); ?>"
                   class=" am-link-muted">
