...
<form action="<?= $url; ?>" method="post" id="check-form-enter">
    ...
    <dl class="form-row">
        ...
        <dt class="form-title">
        <label class="form-title-label"><?= $GLOBALS['_LANG']['MODEL']['MODEL_NAME']; ?><span class="red-tips">*</span></label>
        </dt>
        <dt class="form-text">
        <input class="form-text-input input-leng3 form-input-tips capitalize" data="MODEL-MODEL_NAME_TIPS" id="model-name" name="model_name" type="text" placeholder="<?= $GLOBALS['_LANG']['MODEL']['MODEL_NAME']; ?>" value="<?= $model_name ?>" required onkeyup="value = value.replace(/[^A-Za-z0-9_]/g, '')" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^A-Za-z0-9_]/g,''))" <?= $method == 'POST' ? '' : 'disabled="disabled"' ?> />
        </dt>
        ...
        <dt class="form-text">
        <input class="form-text-input input-leng3 form-input-tips" data="MODEL-MODEL_DISPLAY_NAME_TIPS" id="display-name" name="display_name" type="text" placeholder="<?= $GLOBALS['_LANG']['COMMON']['DISPLAY_NAME']; ?>" value="<?= $GLOBALS['_LANG']['MENU_LIST'][$lang_key] ?>" required />
        </dt>

        <dt class="form-title">
        <label class="form-title-label"><?= $GLOBALS['_LANG']['MODEL']['IS_SEARCH']; ?><span class="red-tips">*</span></label>
        </dt>
        <dt class="form-text">
        ...
        <dt class="form-title">
        <label class="form-title-label"><?= $GLOBALS['_LANG']['MODEL']['MODEL_ATTR']; ?><span class="red-tips">*</span></label>
        </dt>
        <dt class="form-text">
        <label class="form-radio-label">
            <input class="form-radio" type="radio" name="model_attr" value="1" required <?= $model_attr == '1' ? 'checked="checked"' : '' ?> />
            <span>
                <?= $GLOBALS['_LANG']['MODEL']['RECEPTION']; ?>
            </span>
        </label>
        <label class="form-radio-label">
            <input class="form-radio" type="radio" name="model_attr" value="2" required <?= $model_attr == '2' ? 'checked="checked"' : '' ?> />
            <span>
                <?= $GLOBALS['_LANG']['MODEL']['BACKSTAGE']; ?>
            </span>
        </label>
        </dt>

        <dt class="form-title">
        <label class="form-title-label"><?= $GLOBALS['_LANG']['MODEL']['MODEL_STATUS']; ?><span class="red-tips">*</span></label>
        </dt>
        <dt class="form-text">
        <label class="form-radio-label">
