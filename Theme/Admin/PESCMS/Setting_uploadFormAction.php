...
<form action="" method="post" id="check-form-enter">
    ...
    <dl class="form-row">
        ...
        <dt class="form-title">
        <label class="form-title-label"><?= $GLOBALS['_LANG']['SETTING']['UPLOAD_IMG_FORMAT']; ?><span class="red-tips">*</span></label>
        </dt>
        <dt class="form-text">
        ...
        <dt class="form-title">
        <label class="form-title-label"><?= $GLOBALS['_LANG']['SETTING']['UPLOAD_FILE_FORMAT']; ?><span class="red-tips">*</span></label>
        </dt>
        <dt class="form-text">
