                ...
                <ul class="am-list admin-sidebar-list">
                    <?php foreach ($menu as $topkey => $topValu) : ?>
                        <li class="admin-parent">
                            <a class="am-cf" data-am-collapse="{target: '#<?= $topValu['menu_id'] ?>'}"><span class="<?= $topValu['menu_icon'] ?>"></span> <?= $topValu['menu_name']; ?>
                            ...
                            <?php if (!empty($topValu['menu_child'])): ?>
                                <ul class="am-list am-collapse admin-sidebar-sub" id="<?= $topValu['menu_id'] ?>">
                                    <?php foreach ($topValu['menu_child'] as $key => $value) : ?>
                                        <li>
                                            <a href="<?= $label->url($value['menu_url']); ?>" class="am-cf menu-link"><span class="<?= $value['menu_icon'] ?>"></span> <?= $value['menu_name']; ?>
                                            </a></li>
                                    <?php endforeach; ?>
                                </ul>
                            <?php endif; ?>
                    ...
                    <?php endforeach; ?>
                    <li><a href="<?= $label->url(GROUP . '-Index-logout'); ?>"><span class="am-icon-sign-out"></span> 注销</a>
                    </li>
                </ul>
